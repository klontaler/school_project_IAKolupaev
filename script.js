// function modalOpen(button, author, array) {
//   button.onclick = function(event) {
    

//     modalWindow.add('modalOpen');
//   };
...
// let buttonOstrovskiy = document.getElementById('buttonOstrovskiy');
// let buttonTurgenev = document.getElementById('buttonTurgenev');
// let buttonGoncharov = document.getElementById('buttonGoncharov');
// let buttonNekrasov = document.getElementById('buttonNekrasov');
// let buttonDostoevskiy = document.getElementById('buttonDostoevskiy');
// let buttonTolstoy = document.getElementById('buttonTolstoy');
// let buttonLeskov = document.getElementById('buttonLeskov');
// let buttonSaltykov2 = document.getElementById('buttonSaltykov2');
// let buttonAndreev = document.getElementById('buttonAndreev');
// let buttonGorkiy = document.getElementById('buttonGorkiy');
// let buttonSholohov = document.getElementById('buttonSholohov');
// let buttonMartin = document.getElementById('buttonMartin');
// let buttonSaltykov = document.getElementById('buttonSaltykov');
// let buttonPushkin = document.getElementById('buttonPushkin');
// let buttonFitz = document.getElementById('buttonFitz');
// let buttonRemark = document.getElementById('buttonRemark');
